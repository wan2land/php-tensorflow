...
// argument info
// name, ?, ?, number of required params
...
static zend_function_entry tf_status_methods[] = {
    PHP_ME(Tensorflow_Status, set,          arginfo_set,    ZEND_ACC_PUBLIC)
...
static PHP_MINIT_FUNCTION(tensorflow)
{
     ...
     */
    {
        ...
        // zend_declare_class_constant_long(&temp_ce, "OK", 2, 0);
        // zend_declare_class_constant_long(&temp_ce, "CANCELLED", 10, 1);
        // zend_declare_class_constant_long(&temp_ce, "UNKNOWN", 8, 2);
        // zend_declare_class_constant_long(&temp_ce, "INVALID_ARGUMENT", 17, 3);
        // zend_declare_class_constant_long(&temp_ce, "DEADLINE_EXCEEDED", 18, 4);
        // zend_declare_class_constant_long(&temp_ce, "NOT_FOUND", 10, 5);
        // zend_declare_class_constant_long(&temp_ce, "ALREADY_EXISTS", 15, 6);
        // zend_declare_class_constant_long(&temp_ce, "PERMISSION_DENIED", 18, 7);
        // zend_declare_class_constant_long(&temp_ce, "RESOURCE_EXHAUSTED", 19, 8);
        // zend_declare_class_constant_long(&temp_ce, "FAILED_PRECONDITION", 20, 9);
        // zend_declare_class_constant_long(&temp_ce, "ABORTED", 8, 10);
        // zend_declare_class_constant_long(&temp_ce, "OUT_OF_RANGE", 13, 11);
        // zend_declare_class_constant_long(&temp_ce, "UNIMPLEMENTED", 14, 12);
        // zend_declare_class_constant_long(&temp_ce, "INTERNAL", 9, 13);
        // zend_declare_class_constant_long(&temp_ce, "UNAVAILABLE", 12, 14);
        // zend_declare_class_constant_long(&temp_ce, "DATA_LOSS", 10, 15);
        // zend_declare_class_constant_long(&temp_ce, "UNAUTHENTICATED", 16, 16);
